...
<!-- 图文列表区域 -->
	...
	<view class="item animated fadeInUp" >
        <!-- 头部部分 -->
        <view class="header">
          <view class="header-left">
            ...
            <image
              class="portrait"
              :src="tempList.userPic"
            />
            <text class="name">{{tempList.userName}}</text>
          </view>
          <view class="header-right">
						<block >
            <view class="attention icon iconfont icon-zengjia"  v-if="!tempList.isGuanZhu"  @tap="attention" >  关注</view>
						</block>
        ...
        <view class="content">
          <image
            class="img"
            :src="tempList.content"
          />
					<block v-if="tempList.type =='video'">
							<view class="pause icon iconfont icon-bofang"> </view>
							<view class="playnum"> {{tempList.playNum}}万次播放{{tempList.timeNum}}</view>
					</block>
          ...
          <view class="left">
            ...
            <view class="praise" 	@tap="caozuo('ding')">
						  	<block v-if="tempList.infoNum.status==1" >
								<image class="iconImg"  src="../../static/images/praise_active.png"/>	
							</block>
							<block v-else>
            ...
            <view class="trample" 	@tap="caozuo('cai')">
							<block v-if="tempList.infoNum.status==2">
									<image class="iconImg"  src ="../../static/images/trample_active.png"/>
							</block>
							<block v-else>
